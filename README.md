...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dttxml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13946&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dttxml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dttxml` can be installed with:

```
conda install dttxml
```

It is possible to list all of the versions of `dttxml` available on your platform with:
